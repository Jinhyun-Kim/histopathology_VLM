...
pixel_values1 = load_image('./examples/image1.png', max_num=12).to(torch.bfloat16).cuda()
pixel_values2 = load_image('./examples/image2.png', max_num=12).to(torch.bfloat16).cuda()
